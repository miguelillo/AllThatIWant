                ...
                <table class="shop_table">
                    ...
                    <tbody>
                        ...
                        <tr class="cart_item">
                            ...
                            <td class="product-add-bag"><a class="add_bag"href="Controller?opID=RealizarPedido&referencia=<%=prodRef%>" class="fa fa-shopping-cart"></i><span>Añadir al carrito</span></a></td>
